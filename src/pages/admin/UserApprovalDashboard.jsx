...
const UserApprovalDashboard = () => {
  ...
  const canApproveUsers =
    hasPermission("canApproveUsers") || user?.accountType === "admin";
    ...
    try {
      ...
      switch (action) {
        case "approve":
          ...
          updateData.permissions = getDefaultPermissions(
      ...
      showNotification(
        `User ${actionMessages[action]} successfully`,
        "success",
      );
    } catch (error) {
  ...
  const handleBulkAction = async (action) => {
    ...
    try {
      ...
      showNotification(
        `${selectedUsers.size} users ${action}ed successfully`,
        "success",
      );
    } catch (error) {
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
        {[
          ...
          <div
            key={index}
            className={`${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-100"} rounded-xl shadow-md border p-6`}
          >
      ...
      {selectedUsers.size > 0 && (
        <div
          className={`mb-6 p-4 rounded-lg ${darkMode ? "bg-indigo-900/20 border-indigo-800" : "bg-indigo-50 border-indigo-200"} border`}
        >
          <div className="flex items-center justify-between">
            <span
              className={`text-sm ${darkMode ? "text-indigo-300" : "text-indigo-700"} font-medium`}
            >
      ...
      >
        <div
          className={`px-6 py-4 border-b ${darkMode ? "border-gray-700" : "border-gray-100"} flex justify-between items-center`}
        >
          <h2
        ...
        {filteredUsers.length > 0 ? (
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              <thead>
                <tr
                  className={`${darkMode ? "bg-gray-700 border-gray-600" : "bg-gray-50 border-gray-100"} border-b`}
                >
                  <th
                    className={`px-6 py-3 text-xs font-medium ${darkMode ? "text-gray-400" : "text-gray-500"} uppercase tracking-wider`}
                  >
                    Select
                  </th>
                  <th
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col">
                        <span
                          className={`text-sm ${darkMode ? "text-gray-200" : "text-gray-900"} capitalize`}
                        >
                    ...
                    <td className="px-6 py-4">{getStatusBadge(userData)}</td>
                    <td className="px-6 py-4">
                      <span
                        className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-500"}`}
                      >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center space-x-2">
                        ...
                        {(userData.status === "suspended" ||
                          ...
                          <button
                            onClick={() =>
                              handleUserAction(userData.id, "reactivate")
                            }
                            disabled={processing.has(userData.id)}
          ...
          <div className="p-12 text-center">
            ...
            <h3
              className={`text-lg font-medium ${darkMode ? "text-gray-300" : "text-gray-900"} mb-2`}
            >
              No users found
            </h3>
