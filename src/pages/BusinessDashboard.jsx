...
} from "../services/businessUpgradeService";
...
const SimpleBarChart = ({
  ...
  return (
    <div
      className={`${themePrefix}-card p-6 transition-all duration-300 hover:scale-105 animate-slideInUp`}
    >
...
const SellerFeatures = ({ stats, darkMode, themePrefix }) => (
  <div className="space-y-8">
      ...
      {[
        ...
        >
          ...
          <div className="flex items-center justify-between relative z-10">
            ...
            <div
              className={`text-5xl p-4 rounded-xl transition-all duration-300 group-hover:scale-125 group-hover:rotate-12 ${
                darkMode
    ...
    <div
      className={`${themePrefix}-card p-8 transition-all duration-500 hover:scale-[1.02] animate-slideInUp`}
  ...
  return (
    <>
      <div className="space-y-8">
        ...
        {pendingUpgrade && (
          <div
            className={`${themePrefix}-card p-6 animate-pulse-slow animate-slideInUp`}
          >
            {darkMode && <div className="card-glow"></div>}
            {!darkMode && <div className="neumorph-card-glow"></div>}
        ...
        {!pendingUpgrade && (
          <div
            className={`${themePrefix}-cta-card p-8 transition-all duration-500 hover:scale-[1.02] animate-slideInUp`}
            ...
            <div className="flex items-start space-x-6 relative z-10">
              ...
              <div className="flex-1">
                    ...
                    <div className="relative z-10">
                      ...
                      >
                        <li className="flex items-center">
                          ...
                          {darkMode
                            ? "Deploy unlimited neural products"
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  >
                    <svg
                      className="btn-icon mr-3 group-hover:bounce transition-transform duration-300"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
...
const BusinessDashboard = () => {
      ...
      try {
        ...
        if (isSeller) {
          ...
          const monthlySales = sellerOrders
            .filter(
              (order) => order.createdAt.getMonth() === new Date().getMonth(),
            )
          ...
          businessStats = {
            totalProducts,
            monthlySales,
            activeOrders: sellerOrders.filter(
          ...
          const avgOrderValue =
            buyerOrders.length > 0 ? totalSpent / buyerOrders.length : 0;
          ...
          >
            ...
            >
              <span className="font-bold">
                {darkMode ? "RETRY CONNECTION" : "Retry Loading"}
              </span>
            </button>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <SecretInvasionBackground intensity={0.5} enableGlitch={darkMode} />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between">
            <div className="mb-6 lg:mb-0">
              ...
              >
                {isSeller
                  ? darkMode
                    ? "SELLER NEURAL COMMAND"
                    : "Seller Dashboard"
                  : darkMode
                    ? "BUYER NEURAL INTERFACE"
                    : "Buyer Dashboard"}
              </h1>
              <p
                className={`text-xl ${
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div
                className={`${themePrefix}-card px-6 py-3 transition-all duration-300 hover:scale-110`}
              >
                {darkMode && <div className="card-glow"></div>}
                {!darkMode && <div className="neumorph-card-glow"></div>}
