      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <main className="flex-1 bg-white p-8 rounded-lg shadow text-gray-800">
          ...
          <section id="overview" className="mb-10">
            ...
            <p>
              At WholesaleHub, your privacy is important to us. This policy
              explains what data we collect, how we use it, and your rights. By
          ...
          <section id="data-collection" className="mb-10">
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>
                <strong>Account Information:</strong> Name, email, business
                details
              </li>
              <li>
                <strong>Transaction Data:</strong> Orders, payments, invoices
              </li>
              <li>
                <strong>Device Info:</strong> IP address, browser, location
              </li>
              <li>
                <strong>Communication Logs:</strong> Emails, support requests
              </li>
            </ul>
          </section>
          ...
          <section id="cookies" className="mb-10">
            ...
            <p className="mb-3">
              We use cookies and similar tools to personalize your experience
              and analyze usage:
            </p>
            <ul className="list-disc list-inside space-y-1">
              <li>
                <strong>Essential:</strong> Required for app functionality
              </li>
              <li>
                <strong>Analytics:</strong> Helps us improve user experience
              </li>
              <li>
                <strong>Marketing:</strong> Used for offers and ads (if
                applicable)
              </li>
            </ul>
          </section>
          ...
          <section id="contact">
            ...
            <p className="flex items-center text-gray-700">
              ...
              <span>
                Email us at:{" "}
                <a
                  href="mailto:privacy@wholesalehub.com"
