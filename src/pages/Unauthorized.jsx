  ...
  const getMessageForUser = () => {
    if (isBuyer) {
      return {
        ...
        message:
          "As a Business Buyer, you have access to purchase products but cannot manage inventory. This feature is available for Business Sellers, Managers, and Administrators.",
        suggestions: [
          { text: "Browse Product Catalog", link: "/catalog", icon: "🛒" },
          { text: "View Your Orders", link: "/orders", icon: "📋" },
          {
            text: "Go to Business Dashboard",
    ...
    if (isSeller) {
      return {
        ...
        message:
          "This area requires additional permissions that your account doesn't currently have. Contact your administrator if you believe this is an error.",
        suggestions: [
    ...
    return {
      ...
      message:
        "The page you're trying to access requires special permissions. Please check with your administrator or use the navigation below.",
      suggestions: [
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isBuyer && (
          <div
            className={`mt-6 p-4 rounded-lg ${darkMode ? "bg-orange-900/20 border-orange-800" : "bg-orange-50 border-orange-200"} border`}
          >
            <h4
              className={`font-medium mb-2 ${darkMode ? "text-orange-300" : "text-orange-800"}`}
            >
              💡 Want to manage inventory?
            </h4>
            <p
              className={`text-sm ${darkMode ? "text-orange-200" : "text-orange-700"} mb-3`}
            >
              Upgrade to a Seller account to list products, manage inventory,
              and process orders.
            </p>
            <Link
              to="/business"
