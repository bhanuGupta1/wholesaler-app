...
const ContactSupport = () => {
  ...
  const userFAQs = [
    {
      ...
      answer:
        "Go to the login page and click 'Forgot Password'. Enter your email and follow the instructions.",
      category: "account",
    },
    {
      question: "Why can't I see all products in the catalog?",
      answer:
        "Product visibility depends on your account type and permissions. Contact your administrator for access.",
      category: "inventory",
    },
    {
      question: "How do I track my order status?",
      answer:
        "Visit the Orders section in your dashboard to see real-time order status and tracking information.",
      category: "orders",
    },
    {
      question: "What file formats are supported for product uploads?",
      answer:
        "We support CSV files for bulk uploads and JPG/PNG images for product photos.",
      category: "technical",
    },
  ];
  ...
  const fetchUserTickets = async () => {
    ...
    try {
      ...
      try {
        const testQuery = query(collection(db, "supportTickets"), limit(1));
      ...
      if (error.code === "permission-denied") {
        errorMessage +=
          "You do not have permission to access this data. Please contact support.";
      } else if (error.code === "failed-precondition") {
        errorMessage +=
          "Database index may be missing. Please contact support.";
  ...
  const getBotResponse = (message) => {
    ...
    if (
      lowerMessage.match(
        /^(yes|yeah|yep|ok|okay|sure|sounds good|that helps|thanks|thank you)$/,
      )
    ) {
...
What's the best way I can help you right now?`;
    ...
    if (
      ...
      lowerMessage.includes("order tracking")
    ) {
...
What exactly is happening when you try to use the app?`;
    ...
    if (
      lowerMessage.includes("business account") ||
      lowerMessage.includes("wholesale account") ||
      lowerMessage.includes("tax exempt")
    ) {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Quick Contact Bar */}
        <div
          className={`${darkMode ? "bg-gray-800" : "bg-white"} rounded-lg shadow-md p-4 mb-8`}
        >
        ...
        {/* Tab Navigation */}
        <div
          className={`${darkMode ? "bg-gray-800" : "bg-white"} rounded-lg shadow-md mb-8`}
        >
              ...
              <div>
                ...
                {showSuccess && (
                  ...
                  >
                    <div className="flex items-center">
                      <FaCheckCircle
                        className={`mr-3 text-xl ${darkMode ? "text-green-400" : "text-green-600"}`}
                      />
                      <div>
                        <h3
                          className={`font-medium ${darkMode ? "text-green-300" : "text-green-800"}`}
                        >
                        ...
                        >
                          We'll get back to you within 24 hours. Your ticket has
                          been saved and will appear in "My Tickets".
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {!user && (
                  ...
                  >
                    <div className="flex items-center">
                      <FaExclamationTriangle
                        className={`mr-3 text-xl ${darkMode ? "text-yellow-400" : "text-yellow-600"}`}
                      />
                      <div>
                        <h3
                          className={`font-medium ${darkMode ? "text-yellow-300" : "text-yellow-800"}`}
                        >
                          Please log in to submit tickets
                        </h3>
                        <p
                          className={`text-sm ${darkMode ? "text-yellow-400" : "text-yellow-700"}`}
                        >
                          You need to be logged in to submit and track support
                          tickets.
                        </p>
                      </div>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <FaPaperclip
                          className={`mx-auto mb-2 text-2xl ${darkMode ? "text-gray-400" : "text-gray-500"}`}
                        />
                        <p
            ...
            {activeTab === "tickets" && (
              <div>
                <div className="flex justify-between items-center mb-6">
                  ...
                  >
                    <svg
                      className={`w-4 h-4 mr-2 ${loadingTickets ? "animate-spin" : ""}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                {!user && (
                  <div className="text-center py-12">
                    <FaExclamationTriangle
                      className={`mx-auto text-6xl mb-4 ${darkMode ? "text-yellow-600" : "text-yellow-400"}`}
                    />
                    <h3
                      className={`text-xl font-medium ${darkMode ? "text-gray-400" : "text-gray-500"} mb-2`}
                    >
                      Please log in to view tickets
                    </h3>
                    <p
                      className={`${darkMode ? "text-gray-500" : "text-gray-600"} mb-4`}
                    >
                ...
                {ticketsError && user && (
                  ...
                  >
                    <div className="flex items-start">
                      <FaExclamationTriangle
                        className={`mr-3 text-xl mt-1 ${darkMode ? "text-red-400" : "text-red-600"}`}
                      />
                      <div className="flex-1">
                        <h3
                          className={`font-medium ${darkMode ? "text-red-300" : "text-red-800"} mb-2`}
                        >
                          Unable to Load Tickets
                        </h3>
                        <p
                          className={`text-sm ${darkMode ? "text-red-400" : "text-red-700"} mb-4`}
                        >
                          {ticketsError}
                        </p>
                        <div className="space-y-2">
                ...
                {!loadingTickets && !ticketsError && user && (
                  <>
                    {tickets.length > 0 ? (
                          ...
                          >
                            <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                              <div className="flex items-center space-x-4">
                                ...
                                <span
                                  className={`px-3 py-1 text-xs rounded-full border font-medium ${getStatusColor(ticket.status)}`}
                                >
                                  {ticket.status
                                    .replace("_", " ")
                                    .charAt(0)
                                ...
                                <span
                                  className={`text-sm font-medium capitalize ${getPriorityColor(ticket.priority)}`}
                                >
                                  {ticket.priority} Priority
                                </span>
                              </div>
                              <div
                                className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"} mt-2 md:mt-0`}
                              >
                            ...
                            <h4
                              className={`text-lg font-medium ${darkMode ? "text-gray-200" : "text-gray-800"} mb-2`}
                            >
                              {ticket.subject}
                            </h4>
                            <p
                      ...
                      <div className="text-center py-12">
                        <FaHistory
                          className={`mx-auto text-6xl mb-4 ${darkMode ? "text-gray-600" : "text-gray-400"}`}
                        />
                        <h3
                          className={`text-xl font-medium ${darkMode ? "text-gray-400" : "text-gray-500"} mb-2`}
                        >
              ...
              <div>
                ...
                <div className="space-y-4">
                  {userFAQs.map((faq, index) => (
                    <div
                      key={index}
                      className={`${darkMode ? "bg-gray-700 border-gray-600" : "bg-gray-50 border-gray-200"} border rounded-lg p-6`}
                    >
                      <h3
                        className={`text-lg font-semibold ${darkMode ? "text-white" : "text-gray-900"} mb-3`}
                      >
                        {faq.question}
                      </h3>
                      <p
        ...
        {showLiveChat && (
          <div className="fixed bottom-6 right-6 z-50">
            <div
              className={`${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border rounded-lg shadow-xl w-80 h-96 flex flex-col`}
            >
              {/* Chat Header */}
