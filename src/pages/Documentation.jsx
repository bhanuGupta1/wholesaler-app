        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-600 mb-8">
              Welcome to the WholesaleHub documentation. Here you'll find guides
              and resources to help you make the most of our wholesale
            ...
            <div className="bg-green-50 border-l-4 border-green-400 p-4 mb-6">
              ...
              <p className="text-gray-600">
                Use our search and filter tools to find products from verified
                suppliers. Compare prices, minimum orders, and supplier ratings.
              </p>
            </div>
            ...
            <ul className="text-gray-600 mb-6 space-y-3">
              <li>
                <strong>Product Search:</strong> Advanced search with filters
                for category, price, location, and more
              </li>
              <li>
                <strong>Supplier Profiles:</strong> Detailed supplier
                information including ratings and reviews
              </li>
              <li>
                <strong>Bulk Ordering:</strong> Streamlined process for large
                quantity purchases
              </li>
              <li>
                <strong>Order Tracking:</strong> Real-time updates on your order
                status and shipping
              </li>
              <li>
                <strong>Payment Protection:</strong> Secure payment processing
            ...
            <div className="space-y-4">
              ...
              <div className="border-b border-gray-200 pb-4">
                ...
                <p className="text-gray-600">
                  Minimum order quantities vary by supplier and product. Check
                  the product listing for specific MOQ requirements.
                </p>
              </div>
              ...
              <div className="border-b border-gray-200 pb-4">
                ...
                <p className="text-gray-600">
                  Contact our supplier relations team to begin the verification
                  process. We'll review your business credentials and product
                  quality.
                </p>
              </div>
              ...
              <div className="border-b border-gray-200 pb-4">
                ...
                <p className="text-gray-600">
                  We accept major credit cards, bank transfers, and trade
