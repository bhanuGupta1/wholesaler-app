...
const Registration = () => {
  ...
  const getAccountStatus = (accountType) => {
    switch (accountType) {
      ...
      case 'business':
      case 'manager':
        return { approved: false, status: 'pending_approval', requiresApproval: true };
      default:
        return { approved: false, status: 'pending_approval', requiresApproval: true };
    }
  };
  ...
  const fillDemoAccount = (type) => {
    const demoAccounts = {
      user: {
        firstName: 'John', lastName: 'Doe', email: 'user@wholesaler.com',
        password: 'password123', confirmPassword: 'password123', accountType: 'user',
        businessName: '', phoneNumber: '+1-555-0123', businessType: 'buyer'
      },
      business_buyer: {
        firstName: 'Jane', lastName: 'Smith', email: 'buyer@wholesaler.com',
        password: 'password123', confirmPassword: 'password123', accountType: 'business',
        businessType: 'buyer', businessName: 'Smith Retail Store', phoneNumber: '+1-555-0456'
      },
      business_seller: {
        firstName: 'Mike', lastName: 'Johnson', email: 'seller@wholesaler.com',
        password: 'password123', confirmPassword: 'password123', accountType: 'business',
        businessType: 'seller', businessName: 'Johnson Supply Co', phoneNumber: '+1-555-0789'
      },
      manager: {
        firstName: 'Sarah', lastName: 'Wilson', email: 'manager@wholesaler.com',
        password: 'password123', confirmPassword: 'password123', accountType: 'manager',
        businessName: 'Wilson Management LLC', phoneNumber: '+1-555-0321', businessType: 'buyer'
      }
    };
        ...
        <div className="hidden md:flex md:w-1/2 relative p-12 flex-col justify-between">
          ...
          <div className="relative z-10 space-y-8 animate-fadeInLeft">
            ...
            <div className="space-y-6">
              {[
                { icon: "🆔", title: darkMode ? "MULTI-PROTOCOL ACCESS" : "MULTIPLE ACCOUNT TYPES", delay: "100ms" },
                { icon: "🔒", title: darkMode ? "QUANTUM VERIFICATION" : "SECURE APPROVAL", delay: "200ms" },
                { icon: "⚡", title: darkMode ? "ROLE-BASED NEURAL AUTH" : "ROLE-BASED PERMISSIONS", delay: "300ms" }
              ].map((feature, i) => (
        ...
        <div className="flex flex-col justify-start items-center p-6 md:p-12 w-full md:w-1/2 relative overflow-y-auto">
          ...
          <div className="w-full max-w-md relative z-10 space-y-6 py-8">
            ...
            <div className="text-center animate-slideInUp">
              <h2 className={`text-3xl font-bold mb-4 ${darkMode ? 'cyber-title' : 'neumorph-title'}`}>
            ...
            <form className="space-y-4 animate-slideInUp" onSubmit={handleSubmit}>
              ...
              >
                {loading ? (
                  <span>{darkMode ? 'INITIALIZING...' : 'Creating Account...'}</span>
                ) : (
                  <span>{darkMode ? 'REQUEST NEURAL ACCESS' : 'Create Account'}</span>
                )}
              </button>
            </form>
