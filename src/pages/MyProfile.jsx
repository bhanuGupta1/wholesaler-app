  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto py-8 px-4">
        {/* Header */}
        <div
          className={`${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} rounded-lg shadow-sm border p-6 mb-6`}
        >
          <div className="flex items-center space-x-4">
            <div
              className={`h-20 w-20 rounded-full ${darkMode ? "bg-gray-700" : "bg-gray-200"} flex items-center justify-center overflow-hidden`}
            >
          ...
          <div className="p-6">
            ...
            {activeTab === "account" && (
              <div className="space-y-6">
                ...
                <div
                  className={`p-4 rounded-lg ${darkMode ? "bg-blue-900/20" : "bg-blue-50"} border border-blue-200`}
                >
