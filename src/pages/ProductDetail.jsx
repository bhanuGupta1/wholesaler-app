...
const ProductDetail = () => {
  ...
  if (error) {
    return (
      <div
        className={`container mx-auto px-4 py-8 ${darkMode ? "text-white" : ""}`}
      >
        <div
          className={`${darkMode ? "bg-gray-800" : "bg-white"} shadow rounded-lg p-6`}
        >
          <h1 className="text-2xl font-bold mb-4">{error}</h1>
          <Link
            to="/inventory"
            className={`text-indigo-${darkMode ? "400" : "600"} hover:text-indigo-${darkMode ? "300" : "800"}`}
          >
            ← Back to Inventory
          </Link>
        </div>
    ...
    >
      ...
      >
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <div
              className={`border ${darkMode ? "border-gray-700" : "border-gray-200"} rounded-lg overflow-hidden mb-4`}
            >
              <div
                className={`h-80 bg-gray-100 ${darkMode ? "bg-gray-700" : ""} flex items-center justify-center`}
              >
                {product.imageUrl ? (
                  <img
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div>
                    <label
                      className={`block text-sm font-medium ${darkMode ? "text-gray-400" : "text-gray-500"}`}
                    >
                      Category
                    </label>
                    <span
                      className={`block mt-1 text-sm ${darkMode ? "text-white" : "text-gray-900"}`}
                    >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <span
                      className={`block mt-1 text-sm font-medium ${darkMode ? "text-white" : "text-gray-900"}`}
                    >
            ...
            >
              ...
              <div className="mb-4">
                ...
                <div className="mt-1 flex items-center">
                  ...
                  <span
                    className={`ml-2 text-sm ${darkMode ? "text-gray-400" : "text-gray-500"}`}
                  >
                    units
                  </span>
                </div>
              ...
              <div className="mt-6">
                <label
                  className={`block text-sm font-medium ${darkMode ? "text-gray-400" : "text-gray-500"} mb-2`}
                >
                  Adjust Stock
                </label>
                <div className="flex items-center">
                    ...
                    <button
                      ...
                      onClick={() =>
                        setStockAdjustment((prev) =>
                          Math.max(product.stock * -1, prev - 1),
                        )
                      }
        ...
        <div className="fixed z-10 inset-0 overflow-y-auto">
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
              ...
              <div
                className={`${darkMode ? "bg-gray-800" : "bg-gray-50"} px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse`}
              >
                <button
                  type="button"
