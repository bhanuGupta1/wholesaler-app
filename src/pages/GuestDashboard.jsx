...
const GuestDashboard = () => {
  ...
  const recentUpdates = [
    ...
    },
    {
      ...
      description: darkMode
        ? "Advanced scanning and generation protocols"
    ...
    },
    {
      ...
      description: darkMode
        ? "Quantum encryption improvements"
  ...
  const handleCategoryClick = (category) => {
    navigate(
      `/catalog?category=${encodeURIComponent(category.name.toLowerCase())}`,
    );
  };

  return (
    <div
      className={`${layoutPrefix}-layout-wrapper min-h-screen relative overflow-hidden transition-all duration-1000 ${
      ...
      <div className="relative z-10">
            ...
            <div className="max-w-6xl mx-auto text-center">
              ...
              <div className="space-y-8 animate-slideInUp">
                ...
                <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
                  <div
                    className={`${themePrefix}-card p-2 flex gap-2 transition-all duration-300 hover:scale-105`}
                  >
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12 animate-slideInUp">
                ...
                >
                  {darkMode
                    ? "Explore our quantum-organized product matrix"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12 animate-slideInUp">
                ...
                >
                  {darkMode
                    ? "All neural protocols available to guest users"
                    : "Everything available without registration"}
                </p>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12 animate-slideInUp">
                ...
                >
                  {darkMode
                    ? "Latest enhancements to the neural network"
                ...
                {recentUpdates.map((update, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <span
                        className={`text-xs px-3 py-1 rounded font-bold ml-4 ${
                          update.type === "update"
                            ? darkMode
        ...
        <section className="py-16 relative">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div
                className={`${themePrefix}-cta-card text-center p-12 transition-all duration-500 hover:scale-105 animate-slideInUp`}
              >
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    >
                      ...
                      <svg
                        className="btn-icon ml-3 group-hover:translate-x-1 transition-transform duration-300"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
