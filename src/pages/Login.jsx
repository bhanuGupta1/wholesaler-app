    ...
    return (
      ...
      >
        ...
        {resetEmailSent ? (
          ...
          <div
            className={`max-w-md w-full mx-4 p-8 rounded-xl shadow-lg transition-all duration-700 animate-slideInUp ${
              darkMode ? "cyber-card" : "neumorph-card"
            }`}
          >
            {darkMode && <div className="card-glow"></div>}
            ...
            <div className="text-center mb-6">
              ...
              >
                {darkMode
                  ? "Enter your neural ID to receive reset instructions"
            ...
            <form onSubmit={handleForgotPassword} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder={
                    darkMode ? "neural.id@corp.net" : "your@email.com"
                  }
                  required
                />
              </div>
          ...
          <div className="relative z-10 space-y-8 animate-fadeInLeft">
            ...
            <div className="space-y-6">
              {[
                {
                  icon: "🛡️",
                  title: darkMode ? "QUANTUM SECURITY" : "ENTERPRISE SECURITY",
                  delay: "100ms",
                },
                {
                  icon: "⚡",
                  title: darkMode ? "NEURAL PROTOCOLS" : "SMART INTERFACE",
                  delay: "200ms",
                },
                {
                  icon: "🚀",
                  title: darkMode ? "AI COMMERCE" : "ADVANCED FEATURES",
                  delay: "300ms",
                },
              ].map((feature, i) => (
                <div
        ...
        <div className="flex flex-col justify-center items-center p-6 md:p-12 w-full md:w-1/2 relative">
          ...
          <div className="w-full max-w-md relative z-10 space-y-8">
            ...
            <div className="text-center animate-slideInUp">
              <h2
                className={`text-4xl font-bold mb-4 ${darkMode ? "cyber-title" : "neumorph-title"}`}
              >
                <span
                  className={
