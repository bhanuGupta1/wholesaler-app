...
const QRBulkActions = ({ 
  ...
  return (
    <div className={`${className} p-4 rounded-lg ${darkMode ? 'bg-blue-900/20 border-blue-800' : 'bg-blue-50 border-blue-200'} border`}>
      <div className="flex items-center justify-between">
        <div>
          <h3 className={`font-medium ${darkMode ? 'text-blue-300' : 'text-blue-800'}`}>
            Bulk QR Generation
          </h3>
