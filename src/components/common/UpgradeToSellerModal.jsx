...
const UpgradeToSellerModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div
        className={`${darkMode ? "bg-gray-800" : "bg-white"} rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto`}
      >
        {/* Header */}
        <div
        ...
        <div className="px-6 py-6">
          {/* Benefits Section */}
          <div
            className={`mb-6 p-4 rounded-lg ${darkMode ? "bg-green-900/20 border-green-800" : "bg-green-50 border-green-200"} border`}
          >
            <h3
              className={`font-semibold mb-3 ${darkMode ? "text-green-300" : "text-green-800"}`}
            >
          ...
          {error && (
            <div
              className={`mb-4 p-4 rounded-lg ${darkMode ? "bg-red-900/20 border-red-800" : "bg-red-50 border-red-200"} border`}
            >
              <p
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              >
                ...
                <a
                  href="#"
                  className={`${darkMode ? "text-orange-400 hover:text-orange-300" : "text-orange-600 hover:text-orange-700"} underline`}
                >
