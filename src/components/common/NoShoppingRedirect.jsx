      ...
      >
        ...
        >
          ...
          <div className="space-y-3">
            ...
            >
              Go to {isAdmin ? "Admin" : isManager ? "Manager" : "Your"}{" "}
              Dashboard
            </button>
          ...
          {/* Help Text */}
          <div
            className={`mt-6 p-3 rounded-lg ${darkMode ? "bg-gray-700" : "bg-gray-50"} text-xs`}
          >
            <p className={`${darkMode ? "text-gray-400" : "text-gray-600"}`}>
              💡 <strong>Need to test shopping features?</strong>
              <br />
              Use a regular user account or business account for testing cart
