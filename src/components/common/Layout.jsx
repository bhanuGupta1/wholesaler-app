  ...
  if (isLoginPage) {
    return (
      <div className={`${layoutPrefix}-login-wrapper`}>
        ...
        <SecretInvasionBackground intensity={0.7} enableGlitch={darkMode} />
    ...
    <div className={`${layoutPrefix}-layout-wrapper`}>
      ...
      {darkMode ? (
        <>
          ...
          <canvas
            ref={matrixRef}
            className="fixed inset-0 pointer-events-none z-1 opacity-8"
          />
      ...
      <div
        className={`${layoutPrefix}-layout-content layout-wrapper relative z-10 min-h-screen flex flex-col`}
      >
        {/* THEME-AWARE NAVBAR WITH ENHANCED MODE TOGGLE */}
        <div
          className={`sticky top-0 z-40 transition-all duration-300 ${
            scrolled ? `${themePrefix}-navbar-scrolled shadow-lg` : ""
          }`}
        >
        ...
        {/* THEME-AWARE SIDEBAR */}
        <div
          className={`${themePrefix}-sidebar fixed inset-y-0 left-0 transform ${
        ...
        >
          ...
          <div
            className={`${darkMode ? "sidebar-content" : "neumorph-sidebar-content"} p-6`}
          >
            {/* Sidebar Header */}
            ...
            {user ? (
              <div className="mb-8">
                <div className={`${themePrefix}-user-card`}>
                  ...
                  <div
                    className={`${darkMode ? "user-avatar" : "neumorph-user-avatar"}`}
                  >
                  ...
                  <div className="user-info">
                    <p
                      className={darkMode ? "user-name" : "neumorph-user-name"}
                    >
                      {user.displayName || "User"}
                    </p>
                    <p
                      className={
                        darkMode ? "user-email" : "neumorph-user-email"
                      }
                    >
                      {user.email}
                    </p>
                    <p
                      className={darkMode ? "user-role" : "neumorph-user-role"}
                    >
                      {userRole}
                    </p>
                  </div>
              ...
              <div className="mb-8 flex justify-center">
                <Link
                  to="/login"
                  className={`${themePrefix}-btn ${themePrefix}-btn-primary`}
                >
            ...
            <nav className="space-y-2">
              {[
                ...
                >
                  ...
                  <svg
                    className={darkMode ? "nav-icon" : "neumorph-nav-icon"}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
        ...
        <footer className={`${themePrefix}-footer relative z-10 mt-auto`}>
          ...
          <div
            className={darkMode ? "footer-content" : "neumorph-footer-content"}
          >
            <div className="container mx-auto px-4 md:px-8">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                  <h3
                    className={
                      darkMode ? "footer-heading" : "neumorph-footer-heading"
                    }
                  >
                  ...
                  <ul
                    className={
                      darkMode ? "footer-links" : "neumorph-footer-links"
                    }
                  >
                    <li>
                      <Link
                        to="/about-us"
                        className={
                          darkMode ? "footer-link" : "neumorph-footer-link"
                        }
                      >
                ...
                <div>
                  ...
                  >
                    <li
                      className={
                        darkMode ? "footer-contact" : "neumorph-footer-contact"
                      }
                    >
                      <svg
                        className={
                          darkMode ? "contact-icon" : "neumorph-contact-icon"
                        }
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    ...
                    >
                      ...
                      {darkMode
                        ...
                        : "hello@wholesaler.com"}
                    </li>
                  </ul>
                  <div
                    className={
                      darkMode ? "cyber-social-links" : "neumorph-social-links"
                    }
                  >
                    {["FB", "TW", "LI"].map((social) => (
                      <a
                        ...
                        href="#"
                        className={
                          darkMode ? "social-link" : "neumorph-social-link"
                        }
                      >
                        {darkMode && <div className="social-glow"></div>}
                        {!darkMode && (
                          <div className="neumorph-social-glow"></div>
                        )}
                        {social}
                      </a>
                    ))}
              ...
              <div
                className={
                  darkMode ? "footer-bottom" : "neumorph-footer-bottom"
                }
              >
                <p
                  className={
                    darkMode ? "footer-copyright" : "neumorph-footer-copyright"
                  }
                >
                  &copy; {new Date().getFullYear()}{" "}
                  {darkMode
                    ? "NEURAL WHOLESALER CORP. ALL RIGHTS RESERVED."
                    : "Wholesaler Inc. All rights reserved."}
                </p>
                <div
                  className={
                    darkMode ? "footer-made-by" : "neumorph-footer-made-by"
                  }
                >
                  <p>
                    {darkMode
                      ? "ENGINEERED WITH ⚡ BY THE NEURAL TEAM"
