  ...
  return (
    <div
      className={`sticky top-0 z-50 transition-all duration-500 ${
        scrolled ? `${themePrefix}-navbar-scrolled shadow-2xl` : ""
      }`}
    >
      {/* SecretInvasion Background Integration */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <SecretInvasionBackground intensity={0.6} enableGlitch={darkMode} />
      </div>

      {/* FIXED: Theme-aware navbar wrapper with proper overflow handling */}
      <div
        className={`${themePrefix}-navbar-wrapper relative overflow-visible`}
      >
        {/* Background glow effects */}
        {darkMode && <div className="cyber-navbar-glow animate-pulse"></div>}
        {!darkMode && (
          <div className="neumorph-navbar-glow animate-pulse"></div>
        )}

        {/* Enhanced Top Bar */}
        <div
          className={`py-3 px-4 transition-all duration-500 backdrop-blur-md relative overflow-hidden ${
            darkMode
        ...
        >
          <div className="container mx-auto flex items-center justify-between text-sm relative z-10">
            <p
              className={`hidden md:block font-medium transition-all duration-300 ${
                darkMode
            ...
            <div className="flex items-center space-x-3">
              {[
                {
                  href: "/help-center",
                  text: darkMode ? "HELP MATRIX" : "Help Center",
                },
                {
                  href: "/contact-support",
                  text: darkMode ? "NEURAL SUPPORT" : "Contact Support",
                },
                {
                  to: "/qr-tools",
                  text: darkMode ? "QR PROTOCOLS" : "QR Tools",
                  icon: "📱",
                },
              ].map((item, i) => (
                <div key={i} className="flex items-center">
                  {i > 0 && (
                    <span
                      className={`${darkMode ? "text-cyan-500" : "text-indigo-200"}`}
                    >
                      |
                    </span>
                  )}
                  {item.to ? (
                    ...
                    >
                      {item.icon && (
                        <span className="mr-1 group-hover:scale-125 transition-transform duration-300">
                          {item.icon}
                        </span>
                      )}
        ...
        <nav
          className={`relative z-10 transition-all duration-500 backdrop-blur-lg overflow-visible ${
            darkMode
          ...
          <div className="container mx-auto px-4 py-4 relative z-20">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-3 group">
                <div
                  className={`${themePrefix}-logo transition-all duration-300 group-hover:scale-110 relative overflow-hidden w-12 h-12 ${
              ...
              <div className="hidden md:flex items-center space-x-6 relative">
                ...
                <div
                  className={`h-8 w-px transition-all duration-300 ${
                  ...
                  <div className="relative">
                    <Dropdown onOpenChange={() => {}}>
                      ...
                      >
                        ...
                        <div
                          className={`px-4 py-3 border-b ${darkMode ? "border-cyan-700/50" : "border-gray-200"}`}
                        >
                          <h3
                            className={`text-lg font-bold ${
                              darkMode
                                ? "cyber-title text-cyan-400 cyber-glow"
                                : "neumorph-title text-gray-900"
                            }`}
                          >
                          ...
                          {cartTotal > 0 && (
                            <p
                              className={`text-sm font-medium ${darkMode ? "text-cyan-200" : "text-gray-500"}`}
                            >
                        ...
                        {cart.length === 0 ? (
                          <div className="px-4 py-6 text-center">
                            ...
                            <p
                              className={`text-sm font-medium mb-3 ${darkMode ? "text-cyan-300" : "text-gray-500"}`}
                            >
                              {darkMode
                                ? "CART MATRIX EMPTY"
                                : "Your cart is empty"}
                                  ...
                                  <div className="flex items-center space-x-3">
                                    <div
                                      className={`w-12 h-12 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 ${
                                        darkMode
                                          ? "bg-gray-800 border border-cyan-600/50"
                                          : "bg-gray-200"
                                      }`}
                                    >
                                      {item.imageUrl ? (
                            ...
                            >
                              ...
                              >
                                <span className="font-bold">
                                  {darkMode ? "PROCESS ORDER" : "Checkout"} ($
                                  {cartTotal.toFixed(2)})
                                </span>
                              </DropdownItem>
                              <DropdownItem
                              ...
                              >
                                <span className="font-bold">
                                  {darkMode ? "VIEW CART MATRIX" : "View Cart"}
                                </span>
                              </DropdownItem>
                            </div>
                          </>
                  ...
                  <div className="relative">
                    <Dropdown onOpenChange={() => {}}>
                      <DropdownTrigger className="flex items-center space-x-2 focus:outline-none group transition-all duration-300 hover:scale-110">
                        <div
                          className={`h-12 w-12 rounded-full p-0.5 shadow-lg overflow-hidden transition-all duration-300 group-hover:ring-4 ${
                            darkMode
                      ...
                      >
                        ...
                        >
                          <p
                            className={`text-sm font-medium ${darkMode ? "text-cyan-300" : "text-gray-500"}`}
                          >
                            {darkMode
                          ...
                          <p
                            className={`text-sm font-bold truncate ${darkMode ? "text-cyan-100 cyber-glow" : "text-gray-900"}`}
                          >
                            {user.email}
                          </p>
                          <p
                        ...
                        <div className="py-1">
                          ...
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className={`h-5 w-5 mr-3 transition-all duration-300 group-hover:rotate-12 ${
                          ...
                          >
                            <span className="mr-3 text-lg animate-pulse">
                              📱
                            </span>
                            <span className="font-bold">
                        ...
                        <div
                          className={`py-1 border-t ${darkMode ? "border-cyan-700/50" : "border-gray-200"}`}
                        >
                          <DropdownItem
                          ...
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className={`h-5 w-5 mr-3 transition-all duration-300 group-hover:rotate-180 ${
        ...
        {mobileMenuOpen && (
          <div
            className={`md:hidden backdrop-blur-lg animate-slideInDown ${
              darkMode
              ...
              {user ? (
                ...
                >
                  <div className="px-4 py-2">
                    <p
                      className={`text-sm font-medium ${darkMode ? "text-cyan-300" : "text-indigo-200"}`}
                    >
                      {user.email}
                    </p>
                  </div>
