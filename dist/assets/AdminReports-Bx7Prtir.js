import{u as B,j as e,L as K,d as y}from"./index-DvFbKyhG.js";import{r as h}from"./vendor-DJ1oPbzn.js";import{g as v,c as $}from"./firebase-DMhjYMbV.js";import{U as A,C as M,T as E}from"./users-D4VIDaiA.js";import{S as k}from"./shopping-cart-Q_1uoxka.js";import{R as Q}from"./refresh-cw-CL3pwOUP.js";import{D as W}from"./dollar-sign-BSghxY9L.js";import{m as U}from"./proxy-CdHMcF3z.js";import{D as Y}from"./download-D2uC-ZLv.js";import"./createLucideIcon-AIsR3Rz6.js";const oe=()=>{var w,D;const{darkMode:s}=B(),[L,j]=h.useState(!0),[n,P]=h.useState({users:[],orders:[],products:[],analytics:{}}),[N,F]=h.useState("30d"),[_,q]=h.useState(new Set),V=async()=>{j(!0);try{const[t,g,o]=await Promise.all([v($(y,"users")),v($(y,"orders")),v($(y,"products"))]),m=t.docs.map(a=>({id:a.id,...a.data()})),l=g.docs.map(a=>({id:a.id,...a.data()})),x=o.docs.map(a=>({id:a.id,...a.data()})),r=l.reduce((a,u)=>a+(u.total||0),0),i=l.length>0?r/l.length:0,d=m.length,c=m.filter(a=>a.accountType==="business").length;P({users:m,orders:l,products:x,analytics:{totalRevenue:r,averageOrderValue:i,totalUsers:d,businessUsers:c,totalOrders:l.length,totalProducts:x.length}})}catch(t){console.error("Error fetching reports data:",t)}finally{j(!1)}};h.useEffect(()=>{V()},[N]);const f=(t,g)=>{let o="";t.users&&(o+=`USERS REPORT
`,o+=`ID,Name,Email,Account Type,Status,Created Date
`,t.users.forEach(r=>{var i,d,c;o+=`"${r.id}","${r.displayName||""}","${r.email}","${r.accountType}","${r.status||"active"}","${((c=(d=(i=r.createdAt)==null?void 0:i.toDate)==null?void 0:d.call(i))==null?void 0:c.toLocaleDateString())||"N/A"}"
`}),o+=`
`),t.orders&&(o+=`ORDERS REPORT
`,o+=`Order ID,Customer Email,Total,Status,Date,Items Count
`,t.orders.forEach(r=>{var i,d,c,a;o+=`"${r.id}","${r.customerEmail||""}","${r.total||0}","${r.status||""}","${((c=(d=(i=r.createdAt)==null?void 0:i.toDate)==null?void 0:d.call(i))==null?void 0:c.toLocaleDateString())||"N/A"}","${((a=r.items)==null?void 0:a.length)||0}"
`}),o+=`
...
`}));const m=new Blob([o],{type:"text/csv;charset=utf-8;"}),l=document.createElement("a"),x=URL.createObjectURL(m);l.setAttribute("href",x),l.setAttribute("download",g),l.style.visibility="hidden",document.body.appendChild(l),l.click(),document.body.removeChild(l)},R=async(t,g)=>{var l,x,r,i,d,c,a,u,S;const o=`
      <html>
        <head>
        ...
        <body>
          ...
          <div class="summary">
            ...
            <p>Total Revenue: $${((d=(i=t.analytics)==null?void 0:i.totalRevenue)==null?void 0:d.toFixed(2))||"0.00"}</p>
    ...
    `,m=window.open("","_blank");m.document.write(o),m.document.close(),setTimeout(()=>{m.print(),m.close()},500)},I=t=>{var l,x,r,i,d,c,a;const g=`Admin Dashboard Report - ${new Date().toLocaleDateString()}`,o=`Admin Dashboard Report Summary:
